...
def test_update_transaction_endpoint_success():
    ...
    email = f"update_succ_{uuid.uuid4().hex[:6]}@rezekify.local"
    reg_res = client.post(
        "/api/v1/auth/register",
        json={
            "email": email,
...
def test_update_transaction_endpoint_not_found():
    ...
    email = f"update_404_{uuid.uuid4().hex[:6]}@rezekify.local"
    reg_res = client.post(
        "/api/v1/auth/register",
        json={
            "email": email,
...
def test_update_transaction_endpoint_invalid_amount():
    ...
    email = f"update_inv_{uuid.uuid4().hex[:6]}@rezekify.local"
    reg_res = client.post(
        "/api/v1/auth/register",
        json={
            "email": email,
...
def test_update_transaction_endpoint_tenant_isolation():
    ...
    # User A
    email_a = f"user_a_{uuid.uuid4().hex[:6]}@rezekify.local"
    reg_a = client.post(
        "/api/v1/auth/register",
        json={
            "email": email_a,
    ...
    # User B
    email_b = f"user_b_{uuid.uuid4().hex[:6]}@rezekify.local"
    reg_b = client.post(
        "/api/v1/auth/register",
        json={
            "email": email_b,
